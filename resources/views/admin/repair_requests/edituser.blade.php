                                        ...
                                        <div class="row">
                                            <div class="form-group smalls">
                                                ...
                                                <input type="radio" name="only_one_residence" value="y"
                                                     placeholder=""  @if ($edituser->only_one_residence== "y") checked @endif>Yes
                                                <input type="radio" name="only_one_residence" value="n"
                                                     placeholder=""  @if ($edituser->only_one_residence== "n") checked @endif>No
                                            </div>
                                            <div class="form-group smalls">
                                                ...
                                                <input type="radio" name="lack_the_finances_resources" value="y"
                                                    placeholder=""  @if ($edituser->lack_the_finances_resources== "y") checked @endif>Yes
                                                <input type="radio" name="lack_the_finances_resources" value="n"
                                                    placeholder=""  @if ($edituser->lack_the_finances_resources== "n") checked @endif>No
                                            </div>
                                        </div>
                                    </div>
                                    {{--  --}}
                                        ...
                                        <div class="row">
                                            <div class="form-group smalls">
                                                ...
                                                <input type="radio" name="older_age" value="y" 
                                                    placeholder="" @if ($edituser->older_age== "y") checked @endif>Yes
                                                <input type="radio" name="older_age" value="n" 
                                                    placeholder="" @if ($edituser->older_age== "n") checked @endif>No
                                            </div>
                                            <div class="form-group smalls">
                                                <label>(2) Have a physical disability.</label>
                                                <input type="radio" name="physical_disability" value="y"
                                                    placeholder="" @if ($edituser->physical_disability== "y") checked @endif>Yes
                                                <input type="radio" name="physical_disability" value="n"
                                                     placeholder="" @if ($edituser->physical_disability== "n") checked @endif>No
                                            </div>
                                            <div class="form-group smalls">
                                                <label>(3) Be a veteran or have a veteran residing in your home.</label>
                                                <input type="radio" name="veteran" value="y" 
                                                    placeholder="" @if ($edituser->veteran== "y") checked @endif>Yes
                                                <input type="radio" name="veteran" value="n" 
                                                    placeholder="" @if ($edituser->veteran== "n") checked @endif>No
                                            </div>
                                        </div>
                                    </div>
                                    {{--  --}}
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="bg-light pl-2 pr-2 mb-3" style="border-radius: 10px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">     
                                                            <input type="text" name="name" class="form-control form-control-sm" value="{{$edituser->name}}">
                                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="bg-light pl-2 pr-2 mb-3" style="border-radius: 10px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                <textarea name="street" id="" cols="10" rows="5" class="form-control form-control-sm">{{$edituser->street}}</textarea>
                                            ...
                                            <div class="col-md-12">
                                                <div class="bg-light pl-2 pr-2 mb-3" style="border-radius: 10px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            <input type="text" name="email" class="form-control form-control-sm" value="{{$edituser->email}}">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="bg-light pl-2 pr-2 mb-3" style="border-radius: 10px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            <input type="text" name="zipcode" class="form-control form-control-sm" value="{{$edituser->zipcode}}">
                                                        </div>
                                                ...
                                                <div class="bg-light pl-2 pr-2 mb-3" style="border-radius: 10px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            ...
                                                            class="form-control form-control-sm" value="{{$edituser->extended_zip}}">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            <input type="text" name="primary_phone"
                                                                class="form-control form-control-sm" value="{{$edituser->primary_phone}}">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            <input type="text" name="secondary_phone"
                                                                class="form-control form-control-sm" value="{{$edituser->secondary_phone}}">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            <input type="text" name="alternate_contact_name"
                                                                class="form-control form-control-sm" value="{{$edituser->alternate_contact_name}}">
                                                        </div>
                                                ...
                                                <div class="bg-light pl-2 pr-2 mb-3" style="border-radius: 10px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            ...
                                                            class="form-control form-control-sm" value="{{$edituser->alternate_contact_phone}}">
                                                        </div>
                                                ...
                                                <div class="bg-light pl-2 pr-2 mb-3" style="border-radius: 10px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            ...
                                                            class="form-control form-control-sm" placeholder="$0.00" value="{{$edituser->total_annual_household_income}}">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            <input type="text" name="age_of_owner"
                                                                class="form-control form-control-sm" value="{{$edituser->age_of_owner}}">
                                                        </div>
                                                ...
                                                <div class="bg-light pl-2 pr-2 mb-3" style="border-radius: 10px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            ...
                                                            class="form-control form-control-sm"  value="{{$edituser->years_lived_in_this_home}}">
                                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="bg-light pl-2 pr-2 mb-3 mt-3" style="border-radius: 10px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        class="form-control form-control-sm">{{$edituser->disabled_person_details}}</textarea>
                                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="basic_electrical"
                                                         value="y" placeholder="" @if ($edituser->basic_electrical== "y") checked @endif>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="doors_and_windows"
                                                         value="y" placeholder="" @if ($edituser->doors_and_windows== "y") checked @endif>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="painting"
                                                         value="y" placeholder=""  @if ($edituser->painting== "y") checked @endif>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="wood_repair"
                                                         value="y" placeholder=""  @if ($edituser->wood_repair== "y") checked @endif>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="roof_patching"
                                                         value="y" placeholder="" @if ($edituser->roof_patching== "y") checked @endif>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="gutters"
                                                         value="y" placeholder=""  @if ($edituser->gutters== "y") checked @endif>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="insulation_weatherization"
                                                         value="y" placeholder=""  @if ($edituser->insulation_weatherization== "y") checked @endif>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="wheelchair_ramp"
                                                         value="y" placeholder=""  @if ($edituser->wheelchair_ramp== "y") checked @endif>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="concrete_patching"
                                                         value="y" placeholder=""  @if ($edituser->concrete_patching== "y") checked @endif>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" name="other_repairs"
                                                         value="y" placeholder=""  @if ($edituser->other_repairs== "y") checked @endif>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
