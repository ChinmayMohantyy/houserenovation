<div class="dashboard-navbar">
    ...
    <div class="d-user-avater">
        ...
        <h4>{{auth()->guard('housecaptain')->user()->name}}</h4>
    ...
    <div class="d-navigation">
        <ul id="side-menu">
            <li class=""><a href="{{url('/housecaptain')}}"><i class="fas fa-th"></i>Dashboard</a>
            ...
            <li class=""><a href="{{url('/housecaptain/view_accept-data')}}"><i class="fas fa-th"></i>View Accepted Data</a>
