                        ...
                        <div class="mobile_nav">
                            <ul>
                                <li class="account-drop">
                                    <a href="javascript:void(0);" class="crs_yuo12" data-toggle="dropdown"
                                    ...
                                    <div class="dropdown-menu pull-right animated flipInX">
                                        ...
                                        <div class="ground-list ground-hover-list">
                                            <div class="ground ground-list-single">
                                                <div class="grd_thum"><img src="https://via.placeholder.com/1200x800"
                                                        class="img-fluid rounded" width="50" alt="" /></div>
                                                <div class="ground-content">
                                                    <h6>Web History<small class="float-right text-fade">$120</small>
                                                    </h6>
                                            ...
                                            <div class="ground ground-list-single">
                                                <div class="grd_thum"><img src="https://via.placeholder.com/1200x800"
                                                        class="img-fluid rounded" width="50" alt="" /></div>
                                                <div class="ground-content">
                                                    <h6>Physics Beginning<small
                                                            class="float-right text-fade">$99</small></h6>
                                                    <a href="#" class="small text-danger">Remove</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="ground ground-list-single">
                                                <div class="grd_thum"><img src="https://via.placeholder.com/1200x800"
                                                        class="img-fluid rounded" width="50" alt="" /></div>
                                                <div class="ground-content">
                                                    <h6>Computer Advance<small class="float-right text-fade">$49</small>
                                                    </h6>
                                                    <a href="#" class="small text-danger">Remove</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="btn-group account-drop">
                                        ...
                                        <div class="dropdown-menu pull-right animated flipInX">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="my-profile.html"><i class="fa fa-user-tie"></i>My
                                                        Profile</a></li>
                                                <li><a href="manage-course.html"><i
                                                            class="fas fa-shopping-basket"></i>Manage Courses<span
                                                            class="notti_coun style-2">7</span></a></li>
                                                <li><a href="manage-instructor.html"><i
                                                            class="fas fa-toolbox"></i>Manage Instructor</a></li>
                                                <li><a href="manage-students.html"><i class="fa fa-envelope"></i>Manage
                                                        Students<span class="notti_coun style-3">3</span></a></li>
                                                <li><a href="messages.html"><i class="fas fa-comments"></i>Messages</a>
                                                </li>
                                                <li><a href="login.html"><i class="fa fa-unlock-alt"></i>Sign Out</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
...
{{-- 
                        ...
                        <ul class="nav-menu nav-menu-social align-to-right">
                            ...
                            <li class="account-drop">
                                <?php
                                $notification = App\Models\Notification::get();
                                $data = count($notification);
                                ?>
                                <a href="{{url('/housecaptain/notification')}}" class="crs_yuo12" >
                                    <span class="embos_45"><i class="fas fa-bell"></i><i
                                            class="embose_count red">{{$data}}</i></span>
                                </a>
                            </li>
                            <li>
                                <div class="btn-group account-drop">
                                    ...
                                    <div class="dropdown-menu pull-right animated flipInX">
                                        ...
                                        <ul>
                                            <li><a href="dashboard.html"><i
                                                        class="fa fa-tachometer-alt"></i>Dashboard<span
                                                        class="notti_coun style-1">4</span></a></li>
                                            <li><a href="my-profile.html"><i class="fa fa-user-tie"></i>My Profile</a>
                                            </li>
                                            <li><a href="manage-course.html"><i
                                                        class="fas fa-shopping-basket"></i>Manage Courses<span
                                                        class="notti_coun style-2">7</span></a></li>
                                            <li><a href="manage-instructor.html"><i class="fas fa-toolbox"></i>Manage
                                                    Instructor</a></li>
                                            <li><a href="manage-students.html"><i class="fa fa-envelope"></i>Manage
                                                    Students<span class="notti_coun style-3">3</span></a></li>
