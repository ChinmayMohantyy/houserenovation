...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-xl-7 col-lg-8 col-md-12 col-sm-12">
            <form action="{{url('housecaptain/save-register')}}" method="post">
                @csrf
                        ...
                        <div class="rcs_log_124">
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="text" class="form-control" name="mobile" placeholder="123456789" />
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{url('housecaptain/login')}}">Login Here</a>
                            </div>
                        </div>
